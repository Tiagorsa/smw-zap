...
//DOWNLOAD DOS DADOS DA LOCALIZAÇÃO
...
client.on('message', async msg => {
  if (msg.body === 'location') {  
    const lat = -21.4076929;
    const long = -45.9616966;
    const localizacao = 'https://www.google.com/maps/search/?api=1&query='+lat+','+long;
    getData(localizacao)
    .then(async ()=> {
      const mediaPath2 = MessageMedia.fromFilePath('./location.jpg');
      client.sendMessage(msg.from, mediaPath2, {caption: localizacao});
    })
  }
});
