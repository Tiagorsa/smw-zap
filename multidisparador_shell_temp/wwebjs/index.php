...
<body>
  ...
  <?php
	...
	function button2() {
		...
		$path = '/home/deployzdg/botzdg_multisessao_post/qrcode/' . $sessaoScan . '/qrcode.png';
	...
	function button4() {
		foreach(glob('/home/deployzdg/botzdg_multisessao_post/qrcode/*', GLOB_ONLYDIR) as $dir) {
			$dir = str_replace('/home/deployzdg/botzdg_multisessao_post/qrcode/', '', $dir);
			echo 'Sessão: ' . $dir . '<br>';
		}
		echo "<hr>";
	}
