...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/send-location',
	...
	echo "<br>";
	echo "MENSAGEM => Insira a sua mensagem<br> <textarea style='width:50%' class='form-control' name='titulo' cols='40' rows='5' placeholder='Mensagem que será enviada'></textarea>";
	echo "<br>";
	echo "Latitude => Insira a latitude<br><input style='width:20%' class='form-control' type='text' name='lat' id='lat' placeholder='Insira a Latitude'>";
	echo "<br>";
	echo "Longitude => Insira a longitude<br><input style='width:20%' class='form-control' type='text' name='long' id='long' placeholder='Insira a Longitude'>";
	echo "<br>";
