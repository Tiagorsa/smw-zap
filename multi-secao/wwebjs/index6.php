...
<body>
  ...
  <?php
	...
	function button1() {
		...
		foreach ($lines as $line) {
			...
			curl_setopt_array($curl, array(
			  CURLOPT_URL => 'http://localhost:21465/api/' . $sessao . '/contact-vcard',
	...
	echo "<br>";
	echo "Contato => Insira o número do contato<br><input style='width:20%' class='form-control' type='text' name='contato' id='contato' placeholder='Insira o número do contato'>";
	echo "<br>";
	echo "Nome => Insira o nome do contato<br><input style='width:20%' class='form-control' type='text' name='nome' id='nome' placeholder='Insira Insira o nome do contato'>";
	echo "<br>";
