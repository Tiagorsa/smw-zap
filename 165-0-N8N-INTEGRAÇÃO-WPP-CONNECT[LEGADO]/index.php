...
<body>
  ...
  <?php
	...
	function button4() {
		foreach(glob('C:/Users/Pedro/Desktop/wppconnect/wppconnect-server/userDataDir/*', GLOB_ONLYDIR) as $dir) {
			$dir = str_replace('C:/Users/Pedro/Desktop/wppconnect/wppconnect-server/userDataDir/', '', $dir);
			echo 'Sessão: ' . $dir . '<br>';
		}
		echo "<hr>";
	}
	...
	function button8() {
		$dir = 'C:/Users/Pedro/Desktop/wppconnect/wppconnect-server/userDataDir/' . $_POST['sessaoDelete'];
		if(file_exists($dir)){
